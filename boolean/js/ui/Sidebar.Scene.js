	...
	signals.sceneChanged.add( function ( object ) {
		...
		( function addObjects( objects, pad ) {
			...
			for ( var i = 0, l = objects.length; i < l; i ++ ) {
				...
				var booleanObjectTip = "";
				if(object.id === scene.booleanObject1){
					booleanObjectTip = "<strong>-Object A</strong>";
				}
				else if(object.id === scene.booleanObject2){
					booleanObjectTip = "<strong>-Object B</strong>";
				}
				options[ object.id ] = pad + object.name + booleanObjectTip + ' <span style="color: #aaa">- ' + getObjectType( object )  + '</span>';
